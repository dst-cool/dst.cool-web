...
var e = new (function() {
  ...
  return n2.load = function(e3, n3, i2) {
    ...
    for (var u in e3.strPos = 0, e3.arrayPos = 0, e3.stopNum = 0, e3.loop = e3.options.loop, e3.loopCount = e3.options.loopCount, e3.curLoop = 0, e3.shuffle = e3.options.shuffle, e3.sequence = [], e3.pause = { status: false, typewrite: true, curString: "", curStrPos: 0 }, e3.typingComplete = false, e3.strings)
      e3.sequence[u] = u;
    e3.currentElContent = this.getCurrentElContent(e3), e3.autoInsertCss = e3.options.autoInsertCss, this.appendAnimationCss(e3);
  ...
  }, n2.appendAnimationCss = function(t2) {
    var s2 = "data-typed-js-css";
    if (t2.autoInsertCss && (t2.showCursor || t2.fadeOut) && !document.querySelector("[" + s2 + "]")) {
      var e3 = document.createElement("style");
      e3.type = "text/css", e3.setAttribute(s2, true);
      var n3 = "";
      t2.showCursor && (n3 += "\n        .typed-cursor{\n          opacity: 1;\n        }\n        .typed-cursor.typed-cursor--blink{\n          animation: typedjsBlink 0.7s infinite;\n          -webkit-animation: typedjsBlink 0.7s infinite;\n                  animation: typedjsBlink 0.7s infinite;\n        }\n        @keyframes typedjsBlink{\n          50% { opacity: 0.0; }\n        }\n        @-webkit-keyframes typedjsBlink{\n          0% { opacity: 1; }\n          50% { opacity: 0.0; }\n          100% { opacity: 1; }\n        }\n      "), t2.fadeOut && (n3 += "\n        .typed-fade-out{\n          opacity: 0;\n          transition: opacity .25s;\n        }\n        .typed-cursor.typed-cursor--blink.typed-fade-out{\n          -webkit-animation: 0;\n          animation: 0;\n        }\n      "), 0 !== e3.length && (e3.innerHTML = n3, document.body.appendChild(e3));
    }
  }, e2;
}())();
var n = new (function() {
  ...
  return s2.typeHtmlChars = function(t3, s3, e2) {
    if ("html" !== e2.contentType)
      return s3;
    var n2 = t3.substr(s3).charAt(0);
    if ("<" === n2 || "&" === n2) {
      var i2;
      for (i2 = "<" === n2 ? ">" : ";"; t3.substr(s3 + 1).charAt(0) !== i2 && !(1 + ++s3 > t3.length); )
        ;
      s3++;
    }
    return s3;
    ...
    if (">" === n2 || ";" === n2) {
      var i2;
      for (i2 = ">" === n2 ? "<" : "&"; t3.substr(s3 - 1).charAt(0) !== i2 && !(--s3 < 0); )
        ;
      s3--;
    }
    return s3;
...
var i = function() {
  ...
  return s2.toggle = function() {
    ...
    this.options.onBegin(this), this.typingComplete = false, this.shuffleStringsIfNeeded(this), this.insertCursor(), this.bindInputFocusEvents && this.bindFocusEvents(), this.timeout = setTimeout(function() {
      t3.currentElContent && 0 !== t3.currentElContent.length ? t3.backspace(t3.currentElContent, t3.currentElContent.length) : t3.typewrite(t3.strings[t3.sequence[t3.arrayPos]], t3.strPos);
    }, this.startDelay);
    ...
    true !== this.pause.status ? this.timeout = setTimeout(function() {
      ...
      if ("`" === o.charAt(0)) {
        for (; "`" !== t3.substr(s3 + r).charAt(0) && (r++, !(s3 + r > t3.length)); )
          ;
